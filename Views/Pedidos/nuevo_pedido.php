...
<div class="card">
        ...
        <div class="row">
            <div class="form-group row col-md-9">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="number" id="actEconomica" name="actEconomica" class="form-control" value="692000" readonly>
                </div>
                <div class="form-group col-md-3">
            ...
            <div class="form-group col-md-3">
                <div class="card">
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control" id="subTotal" name="subTotal" min="0.00" value="0.00" step="0.01" style="text-align: right;" readonly>
                    </div>
                    <div class="input-group">
                    ...
                    <div class="input-group">
                        <span class="badge badge-secondary" id="comunicacionSiat">DESCONECTADO</span>
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title">Aeregar productos</div>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="form-group col-md-1">
                    ...
                    <input type="text" class="form-control" id="descProducto" name="descProducto" onchange="calcularstotal()" onkeyup="calcularstotal()">
                </div>
                <div class="form-group col-md-2">
